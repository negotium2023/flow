            ...
            <div class="container-fluid index-container-content">
                <div class="table-responsive h-100">
                    ...
                    <div class="form-group">
                        ...
                        {{Form::select('category',$categories,old('category'),['class'=>'form-control form-control-sm'. ($errors->has('category') ? ' is-invalid' : ''),'placeholder'=>'Category'])}}
                    ...
                    <div class="form-group">
                        ...
                        {{Form::text('label',old('label'),['class'=>'form-control form-control-sm'. ($errors->has('label') ? ' is-invalid' : ''),'placeholder'=>'Label'])}}
